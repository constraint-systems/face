...
function layoutText(cols, text_string) {
  ...
  var i = 0; // lines broken up by intentional returns

  for (var l = 0; l < line_words.length; l++) {
    var line = line_words[l];

    for (var w = 0; w < line.length; w++) {
      var word = line[w]; // if word doesn't fit on line move down one
...
var initialt = {
  text: Object(_components_constants__WEBPACK_IMPORTED_MODULE_6__["layoutText"])(40, short_text),
...
var Home = function Home() {
  ...
  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(40),
