  ...
  var line_words = lines.map(function (l, i) {
    ...
    for (var _i = 0; _i < unbroke_words.length; _i++) {
      ...
      if (word.length < cols) {
        ...
        console.log(word); // let broken = word.match(/.{1,cols}/g)

        console.log(cols);
        var re = new RegExp('.{0,' + cols + '}', 'g');
        var broken = word.match(re);
        console.log(broken);
...
//# sourceMappingURL=index.js.b562b2265835305e1364.hot-update.js.map